...
select op.id_orden_produccion,op.id_estado,op.cantidad_total
,op.fecha_montaje,p.id_producto,p.clave_producto,m.id_material,m.desc_material 
from ordenes_produccion AS op JOIN productos AS p ON op.id_producto = p.id_producto
