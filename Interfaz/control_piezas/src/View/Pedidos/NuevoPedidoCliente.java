...
public class NuevoPedidoCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("FECHA DE ENTRAGA AL CLIENTE");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtNoOrdenCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(8, 8, 8)
        ...
        if (tbListaProductos.getColumnModel().getColumnCount() > 0) {
            tbListaProductos.getColumnModel().getColumn(0).setResizable(false);
            tbListaProductos.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    public JDateChooser getDcFechaEntrega() {
        return dcFechaEntrega;
    }

    public JTable getTbListaPedido() {
        return tbListaPedido;
    }

    public JTable getTbListaProductos() {
        return tbListaProductos;
    }

    public JTextField getTxtNoOrdenCompra() {
