...
public class RegistrarNuevaEntradaMaterial extends javax.swing.JDialog {

    
    public RegistrarNuevaEntradaMaterial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setCbxProveedores(JComboBox<String> cbxProveedores) {
    ...
    public JComboBox<String> getCbxProveedores() {
    ...
    public JTextField getTxtCertificado() {
        return txtCertificado;
    }
    ...
    public JTextField getTxtInspector() {
        return txtInspector;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRAR NUEVA ENTRADA DE MATERIAL");
        ...
        lbFecha.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        ...
        jLabel10.setText("CERTIFICADO");

        txtCertificado.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        txtOrdenCompra.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jLabel12.setText("INSPECTOR");

        txtInspector.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtInspector, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarNuevaEntradaMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistrarNuevaEntradaMaterial dialog = new RegistrarNuevaEntradaMaterial(new javax.swing.JFrame(), true);
